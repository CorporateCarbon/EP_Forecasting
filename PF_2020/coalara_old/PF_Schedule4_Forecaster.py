...
#Schedule 4 FC2024 
CBASE = 596.78 #value from b21 on 'Calculations' Sheet 
CLT   = 184419.56   #Value from B28 on 'Calculations' Sheet  
PERMANENCE_YEARS = 25
...
FIRST_YEAR_DEDUCTION = 12821.0  # in ACCUs (CO2-e) - required for transition (relinquished ACCUs)
APPLY_C_TO_CO2_CONVERSION = False
