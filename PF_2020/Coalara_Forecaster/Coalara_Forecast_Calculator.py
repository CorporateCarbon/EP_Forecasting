...
projectStart = datetime(2022, 6, 25)
num_years = 25  # Always 25 years from project start
...
with open(csvOut, 'w', newline='') as myCSV:
    ...
    prev_result = None
    x = 3  # This needs to be adjusted to the start of the calculations (it refers to the date column in the CEA01 sheet)
